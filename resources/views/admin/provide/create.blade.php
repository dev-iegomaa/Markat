                            ...
                            <div class="widget-header">
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                        <h4>Create New Provide</h4>
                                    </div>
                                </div>
                            </div>
                            <form action="{{route('admin.provide.insert')}}" method="post" class="widget-content widget-content-area" enctype="multipart/form-data">
                                @csrf
                                @include('admin.provide._form')
