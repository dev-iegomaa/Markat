            ...
            <div class="row layout-spacing">
                    ...
                    <div class="user-profile layout-spacing">
                        <div class="widget-content widget-content-area">
                            <div class="d-flex justify-content-between">
                                <h3 class="">Profile</h3>
                                <a href="{{route('admin.edit')}}" class="mt-2 edit-profile"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-3"><path d="M12 20h9"></path><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"></path></svg></a>
                            </div>
                            ...
                            <div class="user-info-list">
                                ...
                                <div class="">
                                    <ul class="contacts-block list-unstyled">
                                        ...
                                        <li class="contacts-block__item">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>{{auth()->user()->updated_at}}
                                        </li>
                                        <li class="contacts-block__item">
                ...
                <div class="col-xl-8 col-lg-6 col-md-7 col-sm-12 layout-top-spacing">
                    ...
                    <div class="statbox widget box box-shadow">
                        ...
                        <form action="{{route('admin.update')}}" method="post" class="widget-content widget-content-area" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="input-group mb-4">
                                ...
                                <input class="@error('name') is-invalid @enderror form-control" type="text" name="name" value="{{value(old('name', auth()->user()->name ?? ''))}}">
                            </div>
                            ...
                            <div class="input-group mb-4">
                                ...
                                <input class="@error('email') is-invalid @enderror form-control" type="text" name="email" value="{{value(old('email', auth()->user()->email ?? ''))}}">
                            </div>
