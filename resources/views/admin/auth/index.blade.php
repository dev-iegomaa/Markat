                    ...
                    <form class="text-left" method="post" action="{{route('admin.auth.login')}}">
                        ...
                        <div class="form">
                            ...
                            <div id="username-field" class="field-wrapper input">
                                ...
                                <input id="email" name="email" type="text" class="@error('email') is-invalid @enderror form-control" placeholder="e.g John_Doe">
                            </div>
                            ...
                            <div id="password-field" class="field-wrapper input mb-2">
                                ...
                                <input id="password" name="password" type="password" class="@error('password') is-invalid @enderror form-control" placeholder="Password">
