                            ...
                            <div class="mt-container mx-auto">
                                <div class="timeline-line">
                                    ...
                                    @forelse($contacts as $contact)
                                        <div class="item-timeline timeline-new">
                                            ...
                                            <div class="t-content">
                                                ...
                                                <p>{{$contact->email}}</p>
                                                <div class="tags">
                                                    <div class="badge badge-primary">Users</div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    @empty
                                        ...
                                        <h5 style="font-size: 14px; color: #009688; font-weight: 700; margin-bottom: 20px;">There Is No Data In Database</h5>
